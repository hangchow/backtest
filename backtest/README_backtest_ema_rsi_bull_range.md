...
```bash
./.venv/bin/python backtest/backtest_ema_rsi_bull_range.py --codes HK.00700 --initial-cash 800000
```

如果你不想隔夜持仓：

```bash
./.venv/bin/python backtest/backtest_ema_rsi_bull_range.py --codes HK.00700 --initial-cash 800000 --flat-at-close
```
