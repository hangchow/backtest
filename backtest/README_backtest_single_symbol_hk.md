...
```bash
./.venv/bin/python backtest/backtest_rsi_reversion.py --codes HK.00700 --fee-account futu_alt --show-trades 0
./.venv/bin/python backtest/backtest_ema_cross.py --codes HK.00700 --fee-account futu_alt --show-trades 0
./.venv/bin/python backtest/backtest_ema_rsi_combo.py --codes HK.00700 --fee-account futu_alt --show-trades 0
./.venv/bin/python backtest/backtest_ema_rsi_bull_range.py --codes HK.00700 --fee-account futu_alt --show-trades 0
./.venv/bin/python backtest/backtest_dual_momentum.py --codes HK.00700 --fee-account futu_alt --show-trades 0
```
